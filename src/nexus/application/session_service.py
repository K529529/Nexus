...
class SessionService:
    ...
    async def context_repository_id(self) -> str:
    ...
    async def context_turns(self, session_id: str) -> list[SessionTurn]:
        """Return durable user-visible turns for bounded context selection."""
        async with self._unit_of_work_factory() as unit_of_work:
